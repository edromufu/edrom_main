...
class RobotSensors():
    ...
    def init_accel(self):
        ...
        self.accel_publisher = self.node.create_publisher(Vector3, '/behaviour/imu_accel', 10)
    ...
    def init_cam(self):
        ...
        self.pubImage = self.node.create_publisher(visionSimImage, '/vision/image_raw', 10)
