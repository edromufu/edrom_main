...
class HeadMover(Node):
    ...
    def __init__(self, supervisor):
        ...
        self.head_service = self.create_service(
            MoveRequest, '/bhv2mov_communicator/head_requisitions',self.move_sim_head)
        self.init_head()
    ...
    def call_clock(self): 
        ...
        if (self.general_supervisor.getTime() - self.last_run) > 0.35:
            # O current_state pode ser None no início. 
            movement = self.req_dict.get(self.current_state, None) 
    ...
    def move_sim_head(self, request, response):
        ...
        """
        self.req_dict['body_alignment'] = request.move_request 
